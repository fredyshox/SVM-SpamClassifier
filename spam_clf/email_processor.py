...
class EmailProcessor(object):
    ...
    def process_email(self, contents, has_header=True):
        contents = self.replace_contents(contents, has_header=has_header)
        #print(contents)
    ...
    def replace_contents(self, contents, has_header=True):
